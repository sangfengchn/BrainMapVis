...
% workbench in system.
hcpwkbc_dir = [hcp_dir '/connectome_workbench'];
wbcmd = [hcpwkbc_dir '/macos/bin_macosx64/wb_command'];
...
addpath(genpath(ccs_vistool));
addpath(genpath(fs_home));
